# information table tesma student rollno name mother father name ,nationality,gender
# another table std roll no , subject ,marks 
# yo table lai eyuta ma naii join garnu paryo and marks ma 1 rw 2 terminal jesma eyta student ko 1 2 3 4 marks aayunu paryo ani firts lai snga join garda tyo marks ma science bhanera tesma avergae marks chahyo
# totsl number of std is 100
# fake data libraray cha use that for the std 
# 8 subject randomize marks
